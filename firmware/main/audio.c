...
void audio_cue(audio_cue_t cue) {
    ...
    case AUDIO_BLOOM:   audio_tone(523, 90);  audio_tone(659, 140); break;   // C5 -> E5
    case AUDIO_SUCCESS: audio_tone(659, 70);  audio_tone(880, 110); break;   // E5 -> A5
    case AUDIO_READY:   audio_tone(440, 120); break;                          // A4
    }
}
